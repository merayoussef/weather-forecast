...
var display5DayForecast = function (data) {
    ...
    document.getElementById('five-day-date-1').innerHTML = data.list[0].dt_txt;
    ...
    document.getElementById('five-day-date-2').innerHTML = data.list[7].dt_txt;
    ...
    document.getElementById('five-day-date-3').innerHTML = data.list[15].dt_txt;
    ...
    document.getElementById('five-day-date-4').innerHTML = data.list[23].dt_txt;
    ...
    document.getElementById('five-day-date-5').innerHTML = data.list[31].dt_txt;
